...
from oiqa_bpr_vmamba.cli.common import resolve_checkpoint_path


def test_resolve_checkpoint_path_raises(tmp_path: Path) -> None:
    cfg = {'output_dir': str(tmp_path / 'missing')}
    try:
        resolve_checkpoint_path(cfg, 'auto')
